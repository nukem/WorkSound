    ...
    <div id="right-col"> 
      ...
      <form action=".?id=<?= $id ?>" method="post" enctype="multipart/form-data" > 
		...
		<td colspan="2">
		  ...
		  <input type="text" name="link_url" class="textfield width-100pct" value="<? if (isset ($_POST['link_url'])) echo htmlspecialchars ($_POST['link_url']); else echo htmlspecialchars ($record['link_url']); ?>" />
		</td>
		<td colspan="2">
