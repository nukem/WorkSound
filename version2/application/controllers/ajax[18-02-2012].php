			...
			$this->db->insert('notifications',array('status'=>$offer_status,'artist_id'=>$histroy_data['artist_id'],'booka_id'=>$histroy_data['booka_id'],'gig_id'=>$gig_data['gig'],'created'=>date('Y-m-d H:i:s')));
              ...
              $si = new SmsInterface (false, false);               
                if($offer_status=='Offer'){
                    $si->addMessage ('0499 477 021','Hi,Congratulations, you have a gig offered to you.Please go to Soundbooka and login to view and accept your offer. You can use  chat function .');
                }elseif($offer_status=='Confirm') {
                    $si->addMessage ('0499 477 021','Hi,Congratulations, you have a gig confirmed to you.Please go to Soundbooka and login to view and accept your offer. You can use the chat function.');                
                }
		...
		//$this->db->update('artist_gig_map',$upd,array('id'=>$_POST['id']));
         //sending SMS to the artist        
           ...
           if($_POST['respond_status']=='Rejected'){
                   ...
                   $si->addMessage ('0499 477 021','Hi,Congratulations, you have a gig accepted to you.Please go to Soundbooka and login to view and accept your offer. You can use the chat function.');
           }
