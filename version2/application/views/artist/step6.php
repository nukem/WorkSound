...
<?php } ?>		
			...
			<fieldset>
				...
				<?php if($test  == '1' && !empty($test) && ($uri_test == $test_id)){?>
				<div class="form_title">Thank you for updating your artist profile on Soundbooka!</div>
				<?php } else { ?>
				<div class="form_title">Thank you for registering as an Artist on Soundbooka!</div>
				<?php } ?>
				<?php if($test  == '1' && !empty($test) && ($uri_test == $test_id)){?>
				<div class="form_block">
					<div class="para2">
					<p>For more information please visit the Soundbooka FAQ page</p>
					</div>
				<input style="float:left; width: 160px;" type="button" onclick="window.location='<?=base_url()?>artist/manage_profile/<?=$id?>'" class="input_continue" value="View & Edit Profile" style="background-image:none;width: 140px !important;">
				</div>
				<?php } else{?>
				<div class="form_block">
					<div class="para2">
