			...
			<fieldset>
				...
				<div class="form_block">
					...
					<?php if($profile_type==7){?>
						...
						<p>Almost there! Here you can provide more information about your band including your experience, releases, festival appearances, professional highlights as well as your social media links. This information will appear on your Soundbooka Profile Page.</p>
					<?php } ?>		
                    ...
                    <? if ($profile_type != 10) : ?>
						<div class="form_item">
							...
							<textarea class="textarea2 infotext" name="info1" id="info1" title="Add more information so that people know more about you. (Min. 30 words)">
                            <?= set_value('info1',$info1); ?><?php //echo symbol_convertion($info1); ?></textarea>
						</div>
						
						<div class="form_item2">
							<label><?=($profile_type==1) ? 'Residencies':'Releases'?></label>
							<?php if($profile_type==1){?>
								<textarea class="textarea2 infotext" name="info2" id="info2" title="Hold down any residencies? List them here. (Max. 30 words)">
                                <?= set_value('info2',@symbol_convertion($info2)); ?></textarea>
							<?php } ?>
							<?php if($profile_type==3){?>
							<textarea class="textarea2 infotext" name="info2" id="info2" title="List your releases here (max 30 words)"><?= set_value('info2',@symbol_convertion($info2)); ?></textarea>
							<?php } ?>
							<?php if($profile_type==7){?>
							<textarea class="textarea2 infotext" name="info2" id="info2" title="List your releases here (max 30 words)"><?= set_value('info2',@symbol_convertion($info2)); ?></textarea>
							<?php } ?>
							<?php if($profile_type==9){?>
							<textarea class="textarea2 infotext" name="info2" id="info2" title="List the releases you have worked on here (max 30 words)"><?= set_value('info2',@symbol_convertion($info2)); ?></textarea>
							<?php } ?>
						</div>
					</div><!--end of form_row-->
					...
					<div class="form_row">
						<div class="form_item">
							...
							<textarea class="textarea2 infotext" name="info3" id="info3" title="List festivals appearances here. (Max. 30 words)"><?= set_value('info3',@symbol_convertion($info3)); ?></textarea>
						</div>
						
						<div class="form_item2">
							<label>Highlights so far</label>
							<textarea class="textarea2 infotext" name="info4" id="info4" title="Performed anywhere special or with someone amazing? (Max. 30 words)"><?= set_value('info4',@symbol_convertion($info4)); ?></textarea>
						</div>
					</div><!--end of form_row-->
					...
					<div class="form_row">
						<div class="form_item">
							...
							<textarea class="textarea2 infotext" name="info1" id="info1" title="Add more information so that people know more about you. (Max. 30 words)"><?= set_value('info1',@symbol_convertion($info1)); ?></textarea>
						</div>
						
						<div class="form_item2">
							<label>Awards</label>
							<textarea class="textarea2 infotext" name="info2" id="info2" title="Won any awards? Please list them here. (Max. 30 words)"><?= set_value('info2',@symbol_convertion($info2)); ?></textarea>
						</div>
					</div><!--end of form_row-->
					...
					<div class="form_row">
						...
						<div class="form_item">
							<label>Highlights so far</label>
							<textarea class="textarea2 infotext" name="info3" id="info3" title="Worked on anything special or with someone amazing? (Max. 30 words)"><?= set_value('info3',@symbol_convertion($info3)); ?></textarea>
						</div>
					
						<div class="form_item2">
							<label>Core Competencies</label>
							<textarea class="textarea2 infotext" name="info4" id="info4" title="Please list the tools you are competent in - software, instruments, etc. (Max. 30 words)"><?= set_value('info4',@symbol_convertion($info4)); ?></textarea>
						</div>
                        <br class="cl" />
					</div><!--end of form_row-->
                    <? endif; ?>
              ...
              <div class="shadow_line_nobg">line</div>
				...
				<input type="button" value="Back" class="btn_back2" name="back" onclick="location.href = '<?php echo base_url() ?>artist/step3/<?php echo($id);?>'" />
