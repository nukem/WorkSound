...
<div align=right class="form_title" style="width: 400px; float:right;"><span style="color:#FF5C32">*</span> This indicates a mandatory field</div>	
	<div style="clear:both;"></div>
			...
			<fieldset>
				...
				<div class="options">
					<label>
						<input name="booka_type" id="booka_type1" type="radio" value="1"  checked="checked" onClick="$('#commerical').show();"/>
						<strong>Commercial</strong>
				  </label>
					
					<label>
						<input name="booka_type" id="booka_type2" type="radio" value="0" <?php if(set_value('booka_type', @$booka_type)==0) echo 'checked="checked"'; ?> onClick="$('#commerical').hide();"/>
		...
		<img src="<?=base_url()?>images/question_mark_icon.png" style = "width:15px;height:15px;"
								alt="" class="img_ask" />
						<strong class="popup"><em>Please enter your business address into the following fields.</em></strong>
					</strong></label>	
