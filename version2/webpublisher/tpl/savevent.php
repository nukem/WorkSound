			...
			<fieldset>
				...
				<div class="form_block">
					...
					<div class="form_row">
						<div class="form_item">
							<label>Email Addressjdfslksjflsdjflksadjfl;skadjflksa;jfdsl;kfsdla;jdsflkdfjlksdfjsdflk;jsfdl;k <span>*</span></label>
					...
					<div class="form_row">
						...
						<img 
						src="<?=base_url()?>images/question_mark_icon.png" alt="" class="img_ask" />
					</strong>
					</label>
