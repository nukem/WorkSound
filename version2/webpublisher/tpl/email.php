        ...
        <div class="right-col-padding1"> 
          <div class="width-99pct"> 
            <table class="rec-table"> 
			  ...
			  <tr>
				  <td colspan="2">
					  <label>Send responses to (seperate email addresses with commas)</label><br />
					  <input type="text" class="textfield width-100pct" name="email_addresses" value="<?php if(isset($record['email_addresses'])) { echo $record['email_addresses']; } ?>" />
				  </td>
				  <td colspan="2">
					  <label>Email Subject (As viewed by recipients)</label><br />
					  <input type="text" class="textfield width-100pct" name="email_subject" value="<?php if(isset($record['email_subject'])) { echo $record['email_subject']; } ?>" />
				  </td>
