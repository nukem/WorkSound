  ...
  // Date: 30 Nov 2011 EM Code starts here
    ...
    // EM Code ends here
     ...
     // $event_day = $list_day.'/'.$month.'/'.$year;
		...
		echo $sql = "select u.id,u.event_title from user_event as u  left join user_event_detail as u_d on u.id = u_d.parenteventid where u_d.startDate <= '".$event_day."' and u_d.endDate >= '".$event_day."'";
		$qry = mysql_query($sql);
