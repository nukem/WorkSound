				...
				<div class="form_block">
                    ...
                    <? if ($profile_type != 10) : ?>
						<div class="form_item">
							...
							<textarea class="textarea2 infotext" name="info1" id="info1" title="Add more information so that people know more about you. (Min. 30 words)"><?= set_value('info1',@symbol_convertion($info1)); ?><?php //echo symbol_convertion($info1); ?></textarea>
						</div>
						
						<div class="form_item2">
							<label><?=($profile_type==1) ? 'Residencies':'Releases'?></label>
							<?php if($profile_type==1){?>
								<textarea class="textarea2 infotext" name="info2" id="info2" title="Hold down any residencies? List them here. (Max. 30 words)"><?= set_value('info2',@symbol_convertion($info2)); ?></textarea>
							<?php } ?>
							<?php if($profile_type==3){?>
