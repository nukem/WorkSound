		...
		echo 
			...
			echo "
			  ...
			  <td colspan=6><table width='100%' id='manage_code_class'><tr>
				...
				<td width='20%'><label>Group 1*</label><br/>
...
-->				<td><label>Code 1*</label><br/>
				  <input type='input' $bascode1style value='$bascode1' name='code[bascode1][]' maxlength='250' class='textfield width-90pct'/></td>
				<td><label>Code 2*</label><br/>
				  <input type='input' $bascode2style value='$bascode2' name='code[bascode2][]' maxlength='250' class='textfield width-90pct'/></td>
				<td><label>Code 3 *</label><br/>
				 <input type='input' $bascode3style value='$bascode3' name='code[bascode3][]' maxlength='250' class='textfield width-90pct'/></td>";?>
                 <?php
			if(!empty($baseid)):
				...
				<td><label>Active</label><br/>			 
				  <input type='hidden'  value='$baseid' name='code[baseid][]'/>
					<select name='code[active][]' class='width-90pct'>$varactiveoption
				  </select>
				</td>
				<td>
					$num_rows
...
-->				<td><label>Code 1*</label><br/>
				...
				<td><label>Code 2*</label><br/>
				  <input type='input' $bascode2style  name='code[bascode2][]' maxlength='250' class='textfield width-90pct'/></td>
				<td><label>Code 3 *</label><br/>
				 <input type='input' $bascode3style  name='code[bascode3][]' maxlength='250' class='textfield width-90pct'/></td>
				
				<td><label>Active</label><br/>			 
				  <input type='hidden'  value='' name='code[baseid][]'/>
					<select name='code[active][]' class='width-90pct'><?php echo $varactiveoption;?>
				  </select>
				</td>
				<td>
