			...
			<div class="info_box_inside">
				<div class="box_title">Register as an Artist on Soundbooka</div>
				<div class="box_cont">
					<p>Hi! Ready to register as an Artist on Soundbooka? Get started now! <br />
						Please fill out the registration form below – it's FREE and simple to complete. <br />
						We will then send you a confirmation email so you can begin creating your Soundbooka Profile Page.
						<br>
						Have you previously joined Soundbooka and wish to make changes to your Profile? <a href="javascript: void(0);"  onclick="$('#login_box').slideToggle();$('#login').slideDown();$('#forgot').slideUp(); " >Sign in here</a>
					</p>
				</div>
			</div>
			</div><!--end of info_box-->
			...
			<fieldset>
				...
				<table width="100%"><tr width="100%">
					<td width="50%">Choose your User ID and Password.<strong class="bubble_info">
