...
$GDok = TRUE;
// ------------ config section --------------------
$IMGFOLDER = '/home/a-web/ae/a9/rwdbgroup.com/public/www/wpdata/images';
$IMGURL = 'http://rwdbg.customers.ilisys.com.au/wpdata/images/';

$IMG_PATH_REPLACE = 'http://rwdbg.customers.ilisys.com.au';


$VIDEOICON = 'video.jpg';
$AUDIOICON = 'audio.jpg';
// language setting   en
$LARGEIMG = 'View large image';
$DELETEIMG = 'Delete image';
$INSERTIMG = 'Insert selected image';
$UPLOADIMG = 'Upload';
$HELPSTR = 'Click on an image to select!';
// -------------------------------------------------
?>
...
function selectimg(i) {
  ...
  document.getElementById('imgalt').innerHTML = '<?php echo $IMGURL ?>/' + img.alt;
}
function deleteimg() {
  if (selected >= 0) {
    doc = frames['frm1'].document;
...
function insertimg() {
  if (selected >= 0) {
    doc = frames['frm1'].document;
    img = doc.getElementById(selected);
    opener.document.forms[0].src.value = '<?php echo str_replace($IMG_PATH_REPLACE, '..', $IMGURL) ?>/'+img.alt;
    window.close();
  }
}
function viewimg() {
