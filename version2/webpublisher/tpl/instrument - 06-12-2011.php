...
class Instrument { 
	function add_editInstrument($runat,$instrument_id=0,$instrument='',$description='',$instrument_category=''){
		ob_start();
		switch($runat){
		case 'local':
		...
		case 'server': 
					if($instrument_id > 0)
						$sql="update instrument set instrument_category='$instrument_category', instrument='$instrument', description='$description' where instrument_id='$instrument_id'";
					else 
						$sql="INSERT INTO instrument(instrument,description,instrument_category) VALUES('$instrument','$description','$instrument_category')";
