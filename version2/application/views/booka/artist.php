                ...
                <div style="min-height:500px;">
                    <?  if (isset($_REQUEST['aid']) && $_REQUEST['aid'] != '') { ?>
						...
						<input type="hidden" id="parent_id" onchange="alert('passed');">
							...
							class="button" onclick="window.open('<?=$cfg['website_url'] ?>/user/directLogin/<?php echo $aid; ?>?url=profile/view/<?php echo $profile_name_url; ?>','mywindowprofile','menubar=1,resizable=1,width=600,height=600,left=500,top=300,scrollbars=1');"/>
