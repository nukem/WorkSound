...
<script></script>
			...
			<fieldset>
                ...
                <div class="form_title">
					...
					<strong class="bubble_info">
						...
						<a href="javascript: void(0);" 
							onclick="window.open('<?=base_url()?>user_agreement','User Agreement','menubar=1,resizable=1,width=600,height=600,left=500,top=300,scrollbars=1');">User Agreement
						</a>.</em></strong>
					</strong>
				</div>
				...
				<div class="form_block">
					...
					<p>Let's hear what you're made of!</p>
					<div class="form_row">
					  <div class="form_item">
						<label>SoundCloud</label>
						  <input name="url" type="text" class="input1 infotext" id="url" title="SoundCloud URL" value=""/>
					...
					<div class="form_row">
						<div class="form_item">
						  <label>Track description <span>*</span></label>
				...
				<div class="form_block">
					<table class="instrument_table" id="tbl_audio">
					  ...
					  <tr class="<?=($ix%2) ? 'tr_even' : ''?>" id="tr_<?=$ma->id?>">
					    ...
					    <td>
							<a href="javascript: void(0);" class="link" rel="audio"><?=character_limiter($ma->url,40)?></a>
							<?php if(substr($ma->url,-4)=='.mp3') { ?>
								<br><object type="application/x-shockwave-flash" data="<?=$this->config->item('base_url')?>version1/player/player_mp3.swf" width="200" height="20">
								<param name="movie" value="player_mp3.swf" />
								<param name="FlashVars" value="mp3=<?= $ma->url?>&amp;bgcolor1=ffffff&amp;bgcolor2=cccccc&amp;buttoncolor=999999&amp;buttonovercolor=0&amp;slidercolor1=cccccc&amp;slidercolor2=999999&amp;sliderovercolor=666666&amp;textcolor=0" />
								</object>
							<?php } ?>
						</td>
				...
				<div class="form_block">
					...
					<div class="form_row">
					  <div class="form_item">
						<label>Vimeo / YouTube</label>
						  <input name="vurl" type="text" class="input1 infotext" id="vurl" title="Vimeo / YouTube" />
						  <em><a href="#">Click here</a> to learn how</em>
						</div>
						<div class="form_or">or</div>
					  <div class="form_item">
					...
					<div class="form_row">
						<div class="form_item">
						  <label>Video description <span>*</span></label>
				...
				<div class="form_block">
					<table class="instrument_table"  id="tbl_video">
					  ...
					  <tr class="<?=($ix%2) ? 'tr_even' : ''?>" id="tr_<?=$mv->id?>">
					    ...
					    <td><a href="javascript: void(0);" onclick="window.open ('<?=$mv->url?>','<?=$mv->title?>','resizable=1,width=450,height=350');" class="link"><?=character_limiter($mv->url,50)?></a></td>
					  ...
					  <div class="form_item">
						<label>Please upload a PDF of your stage plot /tech rider</label>
						  ...
						  foreach($plots as $plot) { ?>
							<input name="plot[]" type="hidden" class="input1 infotext" id="plot" title="" value="<?php echo $plot->plot;?>" />
						  <?php } ?>
						 <em>&nbsp;</em>
						</div>
						<div class="form_item">
			  ...
			  <div class="shadow_line_nobg">line</div>
				...
				<input name="save" type="submit" class="input_continue" id="save" value="Save &amp; Continue" />
				
				<input name="back" type="submit" class="btn_back2" id="back" value="Back" />
...
$(function() {
	...
	$('#add_audio').click(function() 
	{
		...
		validate(murl);validate(mtitle);validate(mdescription);validate(mdate)
		
		if (!validate(murl) || !validate(mtitle) || !validate(mdescription)  || !validate(mdate)) {
