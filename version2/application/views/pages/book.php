...
<div id="artist_info_disp" style="display:none;">				
		...
		<div class="form_item">
			...
			<input name="instrument1" type="text" class="input1" id="instrument1" value="<?php echo set_value('instrument',@$_POST['instrument']); ?>" />
		</div>
             <div class="spacer"></div>
		</div>
        ...
        <div class="form_item">
			...
			<input name="instrument2" type="text" class="input1" id="instrument2" value="<?php echo set_value('instrument',@$_POST['instrument']); ?>" />
       ...
       <div class="spacer"></div>
            <div class="form_title">Line-up</div>
                ...
                <div class="form_item" style="color:#5F5F5F; font-size:13px; font-weight:normal;">
                   <input type="checkbox" name="band_lineup" value="2" />&nbsp;2 piece band
                   </div>
				<div class="form_item" style="color:#5F5F5F; font-size:13px; font-weight:normal;">   
				   <input type="checkbox" name="band_lineup" value="3" />&nbsp;3 piece band
                   </div>
				<div class="form_item" style="color:#5F5F5F; font-size:13px; font-weight:normal;">
				   <input type="checkbox" name="band_lineup" value="4" />&nbsp;4 piece band
                   </div>
				<div class="form_item" style="color:#5F5F5F; font-size:13px; font-weight:normal;">
				   <input type="checkbox" name="band_lineup" value="5" />&nbsp;5 piece band
                   </div>
				<div class="form_item" style="color:#5F5F5F; font-size:13px; font-weight:normal;">
				   <input type="checkbox" name="band_lineup" value="6" />&nbsp;Other
                </div>
				<br class="cl"/>
       </div>
      <div class="spacer"></div>
	   <div class="form_title">Date & Time</div>
		...
		<div class="form_row">
			...
			<div class="form_item">
				<label><font>Start Hours</font> <span></span></label>
				<div style="float:left;" class="simu_select9"><?=form_dropdown('start_time', $time, set_value('start_time',@$start_time), 'id=start_time')?></div>
			</div>
			<div class="form_item">
				<label><font>Start Mins</font> <span></span></label>
				<div style="float:left;" class="simu_select9"><?=form_dropdown('start_min', $min, '', 'id=start_min')?></div>
			</div>
			...
			<div class="form_item">
				<label><font>End Hours</font> <span></span></label>
				<div style="float:left;" class="simu_select9"><?=form_dropdown('end_time', $time, set_value('end_time',@$start_time), 'id=end_time')?></div>
			</div>
			<div class="form_item">
				<label><font>End Mins</font> <span></span></label>
				<div style="float:left;" class="simu_select9"><?=form_dropdown('end_min', $min, '', 'id=end_min')?></div>
			</div>
	...
	<div class="adv_search" style="display:none;">  <div class="spacer"></div>
			<div class="form_row" id="advance_DJ">
                ...
                <div class="form_item">
                    ...
                    <input name="artist_name_a" type="text" class="input1" value="<?php echo set_value('artist_name',@$_POST['artist_name'])?>"/>
                </div>
            	<br class="cl" />
			</div>
         	<div class="form_row" id="advance_solo_artist"> 
                 ...
                 <div class="form_item">
                    ...
                    <input name="artist_name_b" type="text" class="input1" value="<?php echo set_value('artist_name',@$_POST['artist_name'])?>"/>
                </div>
            	<br class="cl" />
			</div>
          <div class="form_row" id="advance_group_band"> 
                 ...
                 <div class="form_item">
                    ...
                    <input name="artist_name_c" type="text" class="input1" value="<?php echo set_value('artist_name',@$_POST['artist_name'])?>"/>
                </div>
            	<br class="cl" />
			</div>
           <div class="form_row" id="advance_prof_service"> 
                 ...
                 <div class="form_item">
                    ...
                    <input name="artist_name_d" type="text" class="input1" value="<?php echo set_value('artist_name',@$_POST['artist_name'])?>"/>
                </div>
            	<br class="cl" />
			</div>
         ...
         <div class="form_row" id="advance_DJ_equipment"> 
                ...
                <div class="form_item"><label>  Do you require the DJ to bring their own equipment?</label></div>
                 ...
                 <div class="form_item" style="width:275px;">
                   <input type="radio" name="band_lineup" value="2_piece_band" /><label><font>&nbsp;I require the DJ to bring their own equipment</font> </label>
				 </div>
				 <div class="form_item" style="width:150px;">
                   <input type="radio" name="band_lineup" value="3_piece_band" /><label><font>&nbsp;I will supply equipment</font> </label>
                </div>
		 ...
		 <br class="cl" />
                ...
                <br class="cl" />
                 ...
                 <div class="form_item" style="width:285px;">
                   <input type="radio" name="band_lineup" value="2_piece_band" /><label><font>&nbsp;I require the band to bring their own equipment</font> </label>
				   </div>
				   <div class="form_item" style="width:150px;">
                   <input type="radio" name="band_lineup" value="3_piece_band" /><label><font>&nbsp;I will supply equipment</font> </label>
                </div>
        ...
        <div class="form_row" id="advance_solo_artist_equipment"> 
                ...
                <br class="cl" />
                 ...
                 <div class="form_item" style="width:285px;">
                   <input type="radio" name="band_lineup" value="2_piece_band" /><label><font>&nbsp;I require the solo artist to bring their own equipment</font> </label>
				   </div>
				   <div class="form_item" style="width:150px;">
                    <input type="radio" name="band_lineup" value="3_piece_band" /><label><font>&nbsp;I will supply equipment</font> </label>
                    </div>
		...
		<div class="form_item" id="another_artist"><div class="spacer"></div>
			...
			<div class="options">
					<label>
							<input name="require_other_artist" type="radio" id="travel_city" value="1"  <?php if(!empty($_POST['require_other_artist'])){ echo 'checked=checked'; } ?> />
							<strong>Yes I require another musician to play with the DJ</strong>
					</label>
					<br class="cl" />	
						<label>
							<input name="require_other_group" type="radio" id="travel_state" value="1" <?php if(!empty($_POST['require_other_group'])){ echo 'checked=checked'; } ?>  />
							<strong>Yes I require a DJ group</strong>
					</label>
					<br class="cl" />	
						<label>
							<input name="require_no_other" type="radio" id="travel_interstate" value="1" <?php if(!empty($_POST['require_no_other'])){ echo 'checked=checked'; } ?> />
...
?>
    ...
    <div style="float:left;width:100%;">
        <div class="total_results" style="width: 45%;text-align:left;font-weight:bold; float:left; padding-top:10px; padding-bottom:10px;">
             <span class="count_result">1</span> of <?php echo ceil(count($results)/10); ?> Pages
        </div>
    ...
    <input type="hidden" name="show_per_page" id="show_per_page">
    				<br class="cl"/>
	<?php // echo "<br><font color=white>sql is $globsql</font>"; ?>
	</div>
<?php
}
if($res == '0'){ 
