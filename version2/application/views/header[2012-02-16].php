...
<div id="header">
		<div class="header_inside">
			...
			<ul class="nav">
				...
				<li><a href="<?=base_url()?>booka/register" class="highlight">Join as a Booka</a></li>
                <? //endif; ?>
...
// foreach($this->session->userdata('artists') as $artist){ $i++;?>
 <form method="post">
 <?php if($this->session->userdata('profile_type') == 'artist'){ ?>
<input style="background-image:none;width: 120px !important;" type="button" value="Notifications" class="input_continue" name="signin" onclick="window.location='<?=base_url()?><?= $this->session->userdata('profile_type')?>/notification/<?= $this->session->userdata('artist_id')?>'" /> &nbsp; &nbsp;
<?}?>
<input style="background-image:none;width: 120px !important;" type="button" value="Personal Info" class="input_continue" name="signin" onclick="window.location='<?=base_url()?><?= $this->session->userdata('profile_type')?>/personal_info/<?= $this->session->userdata('artist_id')?>'" /> &nbsp; &nbsp;
<?php if($this->session->userdata('profile_type') == 'booka'){ ?>
<input style="background-image:none;width: 125px !important;" type="button" value="My Favourites" class="input_continue" name="favourite" onclick="window.location='<?=base_url()?><?= $this->session->userdata('profile_type')?>/manage_favourite/<?= $this->session->userdata('artist_id')?>'" /> &nbsp; &nbsp;
<?php } if($this->session->userdata('profile_type') == 'booka'){ ?>
<input style="background-image:none;width: 120px !important;" type="button" value="My Gigs" class="input_continue" name="gig" onclick="window.location='<?=base_url()?><?= $this->session->userdata('profile_type')?>/manage_gig/<?= $this->session->userdata('artist_id')?>'" /> &nbsp; &nbsp;
<?php } else if($this->session->userdata('profile_type') == 'artist'){?>
<input style="background-image:none;width: 120px !important;" type="button" value="My Gigs List" class="input_continue" name="gig" onclick="window.location='<?=base_url()?><?= $this->session->userdata('profile_type')?>/manage_gig_list/<?= $this->session->userdata('artist_id')?>'" /> &nbsp; &nbsp;
<?php } ?>
<input style="background-image:none;width: 120px !important;" type="button" value="Calendar" class="input_continue" name="gig" onclick="window.location='<?=base_url()?>booka/calender/<?= $this->session->userdata('artist_id')?>'" /> &nbsp; &nbsp;
<input style="background-image:none;width: 120px !important;" type="button" value="My Profiles" class="input_continue" name="signin" onclick="window.location='<?=base_url()?><?= $this->session->userdata('profile_type')?>/manage_profile/<?= $this->session->userdata('artist_id')?>'" /> &nbsp; &nbsp;
<input style="background-image:none;width: 120px !important;" type="button" value="Settings" class="input_continue" name="settings" onclick="window.location='<?=base_url()?><?= $this->session->userdata('profile_type')?>/settings/<?= $this->session->userdata('artist_id')?>'" /> &nbsp; &nbsp;
