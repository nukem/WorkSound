...
?>
					...
					<td colspan="2">
						...
						<input type="text" class="textfield width-300" maxlength="255" value="<?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['videourl']); else echo htmlspecialchars ($record['videourl']); ?>" id="videourl" name="videourl"/>
...
?>
				...
				<tr>
					...
					<td colspan="2">
						<label>Address</label>
						<input type="text" class="textfield width-100pct" maxlength="255" value="<?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['address']); else echo htmlspecialchars ($record['address']); ?>" id="address" name="address"/>
					</td>
					<td colspan="2">
						<label>Suburb</label><br/> 
						<input type="text" class="textfield width-100pct" maxlength="255" value="<?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['suburb']); else echo htmlspecialchars ($record['suburb']); ?>" id="suburb" name="suburb"/>
					</td>
				...
				<tr>
					<td colspan="4">
						...
						<input type="text" id="embed" name="embed" cols="30" rows="10" class="textfield width-100pct" value="<?php if (isset ($_POST['embed'])) echo htmlspecialchars ($_POST['embed']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['embed'])); ?>" />
					</td>
				</tr>
				...
				<tr>
					<td colspan="4">
						...
						<textarea id="details" name="details" cols="30" rows="10" class="textfield height-200 width-100pct tinymce"><?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['details']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['details'])); ?></textarea>
					</td>
				</tr>
				<tr>
					<td>
