...
<div id="page"> 
  ...
  <div id="content"> 
    ...
    <div id="right-col"> 
      <h2 class="bar green"><span>Gallery</span></h2> 
          ...
          <div class="width-99pct"> 
            <table class="rec-table"> 
			  ...
			  <tr>
				  <td colspan="4">
					<label>URL<br /> 
						<input type="text" name="longtitle" value="<? echo $record['longtitle']; ?>" class="textfield width-100pct" /></label>
				  </td>
			  </tr>
