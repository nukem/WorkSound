				...
				<div class="form_block">
					...
					<div class="form_row">
						...
						<div class="form_item">
							...
							<em><a href="http://paypal.com">Click here</a> to create a PayPal account</em>
					  </div><!--end of form_item-->
					...
					<div class="form_row">
						<div class="form_item">
							<label>
								...
								<strong class="bubble_info">
									<img src="<?=base_url()?>images/question_mark_icon.png" style = "width:15px;height:15px;" alt="" class="img_ask" />
									<strong class="popup"><b>arrow</b><em>To operate a business in Australia you need an Australian Business Number (ABN). If playing Gigs is your business (and not just a part time hobby) you are entitled to register for an ABN. To find out if you are entitled to register for an ABN and carry on a business visit <a href="#">www.abr.gov.au.</a> Soundbooka may require verification of your ABN.</em></strong>
								</strong>
							</label>
					...
					<div class="form_row">
						...
						<div class="form_item">
							<label>
								...
								<strong class="bubble_info">
									<img src="<?=base_url()?>images/question_mark_icon.png" style = "width:15px;height:15px;" alt="" class="img_ask" />
									<strong class="popup"><b>arrow</b><em>If you are entitled to an ABN, you may also be required to register for GST. This is important as if you are registered for GST Soudbooka will include GST in the tax invoices it sends to Bookers on your behalf. If you say you are registered for GST, and in fact you are not, you will still be required to remit the GST you collect to the ATO. You can view more information about registering for GST at <a href="#">www.abr.gov.au.</a></em></strong>
								</strong>
							</label>
							<div class="options">
								<label>
