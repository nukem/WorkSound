        ...
        <div class="right-col-padding1"> 
          <div class="width-99pct"> 
            <table class="rec-table"> 
			  ...
			  <tr>
				<td colspan="4"><label>Subject &bull;</label><br /> 
					<input type="text" name="subject" id="subject" value="<?php if (isset ($_POST['subject'])) echo htmlspecialchars ($_POST['subject']); else echo htmlspecialchars ($record['subject']); ?>" maxlength="255" class="textfield width-100pct" /></td>
			  </tr>
			  
			  <tr>
				<td colspan="4"><label>Email From &bull;</label><br /> 
					<input type="text" name="email_from" id="email_from" value="<?php if (isset ($_POST['email_from'])) echo htmlspecialchars ($_POST['email_from']); else echo htmlspecialchars ($record['email_from']); ?>" maxlength="255" class="textfield width-100pct" /></td>
			  </tr>
			  
			  <tr>
				<td colspan="4"><label>CC &bull;</label><br /> 
					<input type="text" name="cc" id="cc" value="<?php if (isset ($_POST['cc'])) echo htmlspecialchars ($_POST['cc']); else echo htmlspecialchars ($record['cc']); ?>" maxlength="255" class="textfield width-100pct" /></td>
			  </tr>
			  
			  <tr>
				<td colspan="4"><label>BCC &bull;</label><br /> 
					<input type="text" name="bcc" id="bcc" value="<?php if (isset ($_POST['bcc'])) echo htmlspecialchars ($_POST['bcc']); else echo htmlspecialchars ($record['bcc']); ?>" maxlength="255" class="textfield width-100pct" /></td>
			  </tr>
			  
			  <tr> 
                <td colspan="4"> 
				<label>Email content &bull;</label><br />
         <textarea name="content" cols="30" rows="10" class="textfield height-200 tinymce"><? if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['content']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['content'])); ?></textarea>
			  ...
			  <tr> 
                <td colspan="4"> 
				<label>SMS content &bull;</label><br />
         <textarea name="sms_content" maxlength='280' style ="width: 100%;heigth:200px" class="textfield height-200"><? if (isset ($_POST['title'])) echo $_POST['sms_content']; else echo $record['sms_content']; ?></textarea>
                </td> 
              </tr>
			  <tr>
				<td colspan="2">
