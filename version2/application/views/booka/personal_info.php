...
?>		
	...
	<table width="100%"><tr width="100%">
		<td width="100%" align="right"><div align=right class="form_title"><span>*</span> This indicates a mandatory field</div></td>
		<td>&nbsp;</td>
	</tr></table>
		...
		<div class="form_row">
						<div class="form_item">
							...
							<input type="text" name="first_name" value="<?= $val['firstname'] ?>" /></div>
						
						<div class="form_item">
							<label>Last Name <span>*</span></label>
							<input type="text" name="last_name" value="<?= $val['lastname'] ?>" /></div>
						<!--<div class="form_item">
