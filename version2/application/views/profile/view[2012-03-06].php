        ...
        return false;
					...
					<div class="features">
								<div class="block-bar" style="margin:0;">
										...
										<?php }else{ ?>
                                        <a class="btn_back booka_artist" id="book_artist" title="Book Artist" alt="Book Artist"  style="width: 55px !important;margin-top: 0px !important;">Book</a>
                                        <?php } ?>
										</div>
										...
										<?php }else{ ?>                                        
                                        	<a class="fav button_continue" id="add_fav" title="Add to Favourite" alt="Add to Favourite" style="width: 155px !important; margin-top: 0px !important;padding:1px;">Add to Favourite</a>
                                        <?php } ?>
										</div>
										...
										<div class="block-content" style="overflow:auto">
												<div class="info">
                                                        ...
                                                        $class ="booka_artist";
                                                            ...
                                                            <img src="<?=base_url()?>images/buttons/book-this-artist.png" alt="book this artist" class="<?php echo $class; ?>" width="328" height="35" />
														</a>
