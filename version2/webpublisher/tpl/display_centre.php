...
<div id="page"> 
  ...
  <div id="content"> 
    ...
    <div id="right-col"> 
      <h2 class="bar green"><span>Display Centre</span></h2> 
      <form action=".?id=<?= $id ?>" method="post" enctype="multipart/form-data" > 
		...
		<td colspan="2">
		  ...
		  <input type="text" name="address_1" class="textfield width-100pct" value="<? if (isset ($_POST['address_1'])) echo htmlspecialchars ($_POST['address_1']); else echo htmlspecialchars ($record['address_1']); ?>" />
		</td>
		<td colspan="2">
		  <label>Address 2</label><br />
		  <input type="text" name="address_2" class="textfield width-100pct" value="<? if (isset ($_POST['address_2'])) echo htmlspecialchars ($_POST['address_2']); else echo htmlspecialchars ($record['address_2']); ?>" />
		</td>
	      </tr>
		...
		<td>
		  ...
		  <input type="text" name="suburb" class="textfield width-100pct" value="<? if (isset ($_POST['suburb'])) echo htmlspecialchars ($_POST['suburb']); else echo htmlspecialchars ($record['suburb']); ?>" />
		</td>
                <td>
		...
		<td>
		  ...
		  <input type="text" name="phone" class="textfield width-100pct" value="<? if (isset ($_POST['phone'])) echo htmlspecialchars ($_POST['phone']); else echo htmlspecialchars ($record['phone']); ?>" />
		</td>
	      </tr>
		...
		<td>
		  <label>Fax</label><br />
		  <input type="text" name="fax" class="textfield width-100pct" value="<? if (isset ($_POST['fax'])) echo htmlspecialchars ($_POST['fax']); else echo htmlspecialchars ($record['fax']); ?>" />
		</td>
		<td>
		  <label>Email</label><br />
		  <input type="text" name="email" class="textfield width-100pct" value="<? if (isset ($_POST['email'])) echo htmlspecialchars ($_POST['email']); else echo htmlspecialchars ($record['email']); ?>" />
		</td>
		<td>
		  <label>Website URL (include http://)</label><br />
		  <input type="text" name="website" class="textfield width-100pct" value="<? if (isset ($_POST['website'])) echo htmlspecialchars ($_POST['website']); else echo htmlspecialchars ($record['website']); ?>" />
		</td>
		<td>
		  <label>Opening Hours</label><br />
		  <input type="text" name="hours" class="textfield width-100pct" value="<? if (isset ($_POST['hours'])) echo htmlspecialchars ($_POST['hours']); else echo htmlspecialchars ($record['hours']); ?>" />
		</td>
	      </tr>
	      ...
	      <tr> 
                <td colspan="4"> 
		  <label>Map</label><br />
		  <div id="map_canvas" style="width: 500px; height: 500px; margin-bottom:5px;"></div>
	      ...
	      <tr>
		<td colspan="2">
				  <label>Upload Display Village Map</label><br />
