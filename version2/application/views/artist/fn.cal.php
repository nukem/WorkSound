...
<script type="text/javascript" language="javascript">
	// Date: 06 Dec'11 EM Code starts here
		...
		{
			window.open('<?=base_url()?>artist/editcalendar?aid=','mywindow','menubar=1,resizable=1,width=500,height=450,left=500,top=300');
			return false;
		}
		
		function openwindow(e, eventid)
		{
			window.open('<?=base_url()?>artist/editcalendar?aid=&eventid='+eventid,'mywindow','menubar=1,resizable=1,width=500,height=450,left=500,top=300');
