		...
		$.post('<?php echo base_url();?>ajax/add_favourite/',{'artist_id':'<?=$id?>', 'booka_id':$('#bookaid').val()},function(data){
					...
					<div class="features">
								<div class="block-bar" style="margin:0;">
										...
										<a class="btn_login book_artist" id="book_artist" title="Book Artist" alt="Book Artist" href="javascript: void(0);" style="width: 100px !important; margin-top: 0px !important;">Book</a>
										<?php } ?>
										</div>
								...
								<div class="details">
										<div class="block-content" style="overflow:auto">
												<div class="info">
														...
														<img src="<?=base_url()?>images/buttons/book-this-artist.png" alt="book this artist" width="328" height="35" />
														</a>
