    ...
    <div id="right-col"> 
      ...
      <form action=".?id=<?= $id ?>" method="post" enctype="multipart/form-data" > 
		...
		<td>
		  ...
		  <select id="content" name="content" class="textfield width-100pct">
		    <option value="from" <?php if((isset($_POST['content']) && $_POST['content'] == 'from') || $record['content'] == 'from') echo 'selected="selected"'; ?>>From</option>
		    <option value="range" <?php if((isset($_POST['content']) && $_POST['content'] == 'range') || $record['content'] == 'range') echo 'selected="selected"'; ?>>Range</option>
		    <option value="custom" <?php if((isset($_POST['content']) && $_POST['content'] == 'custom') || $record['content'] == 'custom') echo 'selected="selected"'; ?>>Custom</option>
		    <option value="hide" <?php if((isset($_POST['content']) && $_POST['content'] == 'hide') || $record['content'] == 'hide') echo 'selected="selected"'; ?>>Hide</option>
		  </select>
		</td>
		<td colspan="3"></td>
	      </tr>
