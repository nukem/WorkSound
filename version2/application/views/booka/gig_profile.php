...
if(!empty($gig_values[0]['start_time'])) {
if($gig_values[0]['start_hour'] == '1')
$sttime = $gig_values[0]['start_time'] + 12;
else 
$sttime = $gig_values[0]['start_time'];
}
if(!empty($gig_values[0]['end_time'])){
if($gig_values[0]['end_hour'] == '1')
$edtime = $gig_values[0]['end_time'] + 12;
else 
$edtime = $gig_values[0]['end_time'];
}
if(!empty($gig_values))
{
...
<?php } ?>		
			...
			<fieldset>
				...
				<div class="form_block">
					<div class="form_row">
						<div class="form_item">
						<label>Type the name of your gig here<span> * </span></label>
						<input name="gig_name" type="text"  style="float:left;" class="input1" id="gig_name" value="<?php echo set_value('gig_name', @$gig_name); ?>"/>
						</div>
						<?php if(empty($gig_name) && $search_add != 1) { ?>
						<div style="padding-top:20px;" class="form_item">
						OR
						</div>
						<div class="form_item">
						<label>
					...
					<div class="form_row" id="commerical">
						...
						<div class="form_item">
                      	...
                      	<div class="form_item">
							<label>Start Min <span>*</span></label>
							<div class="simu_select4">
							<?php $start_min = $start_min / 5; ?>
							<?=form_dropdown('start_min', $min, set_value('start_min',@$start_min), 'id=start_min')?>
							</div>
						</div>
						<div class="form_item">
							<label>
                    	...
                    	<div class="form_item">
							<label>End Min <span>*</span></label>
							<?php $end_min = $end_min / 5; ?>
							<div class="simu_select4">
							<?=form_dropdown('end_min', $min, set_value('end_min',@$end_min), 'id=end_min')?>
							</div>
						</div>
						<br class="cl" />
					</div><!--end of form_row-->
            ...
            <div class="form_title">					Location  <span>*</span> <br class="cl" />
					
					</div>
					<div class="form_row">	
									<label>What is the location of your gig?<span>*</span></label>
						<div class="form_item">
				...
				<div class="form_row">	
				<label >How would you like to pay for your artist?
 <span>*</span></label>
					...
					<div class="form_title">
						<label >Please list any special requirements you have for this gig?
						</label>
					</div>
				<div class="form_row">	
						...
						<div class="form_item">
							<div>
								<div>
									<label>
                                    	<input name="special_requirement" type="text" class="input1" id="special_requirement" value="<?php echo set_value('special_requirement', @$special_requirement); ?>"/>
									</label>
								</div>
...
$(function() {
	...
	$(function() {
		$.ajax({
		  type: "GET",
		  url: "<?=base_url()?>ajax/getStateOptions/<?php echo $country; ?>/<?php echo $state; ?>",
		  async: false
		}).done(function( msg ) {
		  $('#state').html(msg);
