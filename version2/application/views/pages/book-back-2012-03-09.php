	   ...
	   <div class="form_title">Date & Time</div>
		...
		<div class="form_row">
			...
			<div class="form_item">
                ...
                <div class="simu_select9">
                   	<?=form_dropdown('start_min', $min, '', 'id=start_min')?>
                </div>
				</div>
			...
			<div class="form_item">
				...
				<div>
				<div style="float:left;" class="simu_select9">
				 <?=form_dropdown('end_time', $time, set_value('end_time',@$start_time), 'id=end_time')?>
				</div>
                <div class="simu_select9">
                   	<?=form_dropdown('end_min', $min, '', 'id=end_min')?>
                    </div>
                <div style="float:right;">
				<div class="simu_select9">
