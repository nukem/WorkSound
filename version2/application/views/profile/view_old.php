					...
					<div class="features">
								<div class="block-bar">
										<div class="left">
												...
												onClick="window.open('<?php echo $twitter; ?>','mywindow','menubar=1,resizable=1,width=600,height=600,left=500,top=300,scrollbars=1');" style="cursor:pointer;"><?php } ?><img src="<?=base_url()?>images/buttons/twitter.png" alt="twitter" width="26" height="24" /><?php if(!empty($twitter)){?></a><?php } ?>
												<?php if(!empty($facebook)){?><a 
												onClick="window.open('<?php echo $facebook; ?>','mywindow','menubar=1,resizable=1,width=600,height=600,left=500,top=300,scrollbars=1');" style="cursor:pointer;"><?php } ?><img src="<?=base_url()?>images/buttons/fb.png" alt="twitter" width="26" height="24" /><?php if(!empty($facebook)){?></a><?php } ?>
												<a href="#"><img src="<?=base_url()?>images/buttons/calendar.png" alt="calendar" width="18" height="24" /></a></div>
												<?php if(!empty($facebook)){?>
												<a onClick="window.open('<?php echo $plot; ?>','mywindow','menubar=1,resizable=1,width=600,height=600,left=500,top=300,scrollbars=1');" style=" cursor:pointer;"><?php } ?><img src="<?=base_url()?>images/buttons/map_ico-2.png" alt="plot" title="plot" width="26" height="24" /><?php if(!empty($plot)){?></a><?php } ?>
										</div>
										<div class="right">
