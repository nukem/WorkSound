...
<?php } ?>		
	...
	<div style="display:none"><?=$sql; print_r($gigs);?></div>
	<table class="instrument_table" id="tbl_audio">
	  <tr style="border-bottom:1px solid #999999 !important;">
		<th width="50%" style="important;border-left: 1px solid #999999 !important;">Gig Date / Name</th>
