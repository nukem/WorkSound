					...
					<table class="rec-table"> 
						...
						<tr> 
							<td colspan="2"> 
								...
								<input type="text" id="jobposition" name="jobposition" class="textfield width-100pct" value="<?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['jobposition']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['jobposition'])); ?>" />

							</td>
							<td colspan="2">
								<label>Office Role</label>
								<select class="textfield width-100pct" name="jobtype">
									<option<?php if(isset($_POST['jobtype']) && $_POST['jobtype'] == 'Sales' || isset($record['jobtype']) && $record['jobtype'] == 'Sales') { echo ' selected="selected"'; } ?>>Sales</option>
									<option<?php if(isset($_POST['jobtype']) && $_POST['jobtype'] == 'Rentals' || isset($record['jobtype']) && $record['jobtype'] == 'Rentals') { echo ' selected="selected"'; } ?>>Rentals</option>
									<option<?php if(isset($_POST['jobtype']) && $_POST['jobtype'] == 'Admin' || isset($record['jobtype']) && $record['jobtype'] == 'Admin') { echo ' selected="selected"'; } ?>>Admin</option>
									<option<?php if(isset($_POST['jobtype']) && $_POST['jobtype'] == 'Other' || isset($record['jobtype']) && $record['jobtype'] == 'Other') { echo ' selected="selected"'; } ?>>Other</option>
								</select>
							</td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"> 
								...
								<input type="text" id="email" name="email" class="textfield width-100pct" value="<?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['email']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['email'])); ?>" />
							</td>
							
							<td> 
								<label>Mobile</label><br />
								<input type="text" id="mobile" name="mobile" class="textfield width-100pct" value="<?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['mobile']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['mobile'])); ?>" />
							</td>
							
							<td> 
								<label>Telephone</label><br />
								<input type="text" id="telephone" name="telephone" class="textfield width-100pct" value="<?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['telephone']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['telephone'])); ?>" />
							</td>
						</tr>
						<input type="hidden" id="agentid" name="agentid" value="<?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['agentid']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['agentid'])); ?>" />
						<tr> 
							<td colspan="4"> 
								<label><?php echo  $lang[59] ?></label><br />
								<textarea id="about" name="about" cols="30" rows="10" class="textfield height-200 width-100pct tinymce"><?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['about']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['about'])); ?></textarea>
							</td>
						</tr>
						<tr>
							<td colspan="2">
							...
							<td colspan="2"> 
								<label>Marketing Campaign Name (Refers to files below)</label><br />
								<input type="text" id="campaign" name="campaign" class="textfield width-100pct" value="<?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['campaign']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['campaign'])); ?>" />
							</td>
						</tr>
						<tr>
							<td colspan="2">
