            ...
            <div id="right-col"> 
                ...
                <div style="min-height:500px;">
                    ...
                    <input type="button" name="viewprofile" id="cal-btn" value="View Profile" 
							class="button" onclick="window.open('<?php echo($cfg['website_url']) ?>/user/directLogin/<?php echo $aid; ?>?url=profile/view/<?php 
							echo $profile_name_url; ?>','mywindowprofile','menubar=1,resizable=1,width=600,height=600,left=500,top=300,scrollbars=1');"/>
							<input type="button" name="editprofile" id="cal-btn" value="Edit Profile" 
							class="button" onclick="window.open('http://soundbooka.com.au/version2/user/directLogin/<?php 
							echo $aid; ?>','mywindowedit','menubar=1,resizable=1,width=850,height=600,left=300,top=300,scrollbars=1');"/>
