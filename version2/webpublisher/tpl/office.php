        ...
        <div class="right-col-padding1"> 
          <div class="width-99pct"> 
            <table class="rec-table"> 
              ...
              <tr> 
				<td> 
				<label>Extended Title (Used on agent profile)</label><br />
				<input type="text" id="extendedtitle" name="extendedtitle" class="textfield width-100pct" value="<?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['extendedtitle']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['extendedtitle'])); ?>" />
				</td>	
				<td> 
				...
				<input type="text" id="facsimile" name="facsimile" class="textfield width-100pct" value="<?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['facsimile']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['facsimile'])); ?>" />
				</td>
				<td> 
         ...
         <textarea id="address" name="address" cols="30" rows="10" class="textfield height-200 width-100pct tinymce"><?php if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['address']); else echo htmlspecialchars (preg_replace('/src="/', 'src="../', $record['address'])); ?></textarea>
				</td>
              </tr>
			  <tr>
				<td colspan="2">
