...
<div id="div_specialization" style="display:none">                
			<div class="form_title">Specialisation</div>
				...
				<div class="form_block">
                    ...
                    <div class="options">
						<label>
							<input name="equipment" type="radio" id="equipment_1" class="equipment" value="0" <?php echo set_radio('equipment', 0, ((!$equipment) ? TRUE:FALSE)); ?> />
							<strong>I perform on my own equipment</strong>
				    </label>
						
						<label>
							<input name="equipment" type="radio" id="equipment_0" class="equipment" value="1" <?php echo set_radio('equipment', 1, ((1==$equipment) ? TRUE:FALSE)); ?>/>
