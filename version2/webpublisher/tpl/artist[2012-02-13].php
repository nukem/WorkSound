...
<?php class submit {
	...
	if(isset($_POST['email']) && $_POST['email'] != ''){
		$where[] = " usr.email LIKE '%" . $_POST['email'] . "%'";
	}
	if(isset($_POST['phone']) && $_POST['phone'] != ''){
		$where[] = "  phone_number LIKE '%" . $_POST['phone'] . "%'";
	}
	if(isset($_POST['join_status']) && $_POST['join_status'] != ''){
		$where[] = "  (artist.status LIKE '%" . $_POST['join_status']. "%') ";
	}
	if(isset($_POST['type']) && $_POST['type'] != ''){
		$where[] = " artist.profile_type = '" . $_POST['type'] . "'";
	}
                ...
                <div style="min-height:500px;">
                    <?  if (isset($_REQUEST['aid']) && $_REQUEST['aid'] != '') { ?>
						...
						<input type="hidden" id="parent_id" onchange="alert('passed');">
							...
							class="button" onclick="window.open('http://www.soundbooka.com.au/version2/profile/view/<?php 
							...
							class="button" onclick="window.open('http://soundbooka.com.au/version2/artist/step1/<?php 
							echo $aid; ?>','mywindow','menubar=1,resizable=1,width=850,height=600,left=300,top=300,scrollbars=1');"/>
