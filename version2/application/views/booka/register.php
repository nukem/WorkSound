	...
	<img src="<?=base_url()?>images/question_mark_icon.png" style = "width:15px;height:15px;" alt="" class="img_ask" />
				...
				<div class="form_block">
					...
					<div class="form_row">
						<div class="form_item">
							<label>Email Address <span>*</span><strong class="bubble_info">
<strong class="popup" style="opacity: 0; display: none;"><b>arrow</b><em> If you have already registered as an Artist on Soundbooka please use an alternate email address.</em></strong>
<img class="img_ask" alt="" style="width: 15px; height: 15px;" src="http://www.soundbooka.com.au/version2/images/question_mark_icon.png">
</strong></label>
	...
	<img src="<?=base_url()?>images/question_mark_icon.png" style = "width:15px;height:15px;" alt="" class="img_ask" />
					...
					<div class="form_row">
						<div class="form_item">
							...
							<em>You must be at least 18 years old to register <br/> on Soundbooka.</em>                           
